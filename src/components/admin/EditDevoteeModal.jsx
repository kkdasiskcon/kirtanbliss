...
export default function EditDevoteeModal({ devotee, onClose, onUpdate }) {
    ...
    // Normalize skills on load in case they differ in format
    useEffect(() => {
        if (devotee.skills) {
        ...
        <AnimatePresence>
            ...
            >
                <motion.div
                    ...
                    style={{ background: "white", width: "95%", maxWidth: "500px", padding: "0", maxHeight: "90vh", overflowY: "auto" }}
                    initial={{ scale: 0.9, opacity: 0, y: 20 }}
                    animate={{ scale: 1, opacity: 1, y: 0 }}
                    exit={{ scale: 0.9, opacity: 0, y: 20 }}
                    onClick={(e) => e.stopPropagation()}
                >
                    <div className="modal-header" style={{ padding: "1.5rem", borderBottom: "1px solid rgba(0,0,0,0.05)", display: "flex", justifyContent: "space-between", alignItems: "center", position: "sticky", top: 0, background: "white", zIndex: 10 }}>
